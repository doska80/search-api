...
public class QueryStringAdapter {
  ...
  private MultiMatchQueryBuilder buildQueryStringQuery(
    ...
    multiMatchQueryBuilder.field(fieldName, boost).minimumShouldMatch(mm).tieBreaker(0.2f);
            ...
            field -> {
              ...
              if (settingsAdapter.isTypeOf(
                ...
                if (queryStringQueries.containsKey(nestedField))
                  ...
                  queryStringQueries.put(
                      ...
                      nestedQuery(
                          nestedField,
                          buildQueryStringQuery(
                              null, indexName, request.getQ(), boostFieldValues, mm),
                          None));
              } else {
                if (queryStringQueries.containsKey(NOT_NESTED))
                  ...
                  queryStringQueries.put(
                      NOT_NESTED,
                      buildQueryStringQuery(null, indexName, request.getQ(), boostFieldValues, mm));
              }
            });
