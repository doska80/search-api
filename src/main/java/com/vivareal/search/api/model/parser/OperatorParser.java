...
public class OperatorParser {
    ...
    private final Parser<LogicalOperator> logicalOperatorParser = get(LogicalOperator::getOperators, LogicalOperator::get, "logical operator");

    private final Parser<RelationalOperator> relationalOperatorParser = get(RelationalOperator::getOperators, RelationalOperator::get, "relational operator");

    private final Parser<OrderOperator> orderOperatorParser = get(OrderOperator::getOperators, OrderOperator::get, "order operator");
