...
import static com.vivareal.search.api.model.query.RelationalOperator.RANGE;
...
public class FilterParser {
    ...
    private static final Parser<Filter> FILTER_PARSER = or(RANGE_PARSER, VIEWPORT_PARSER, LIKE_PARSER, NORMAL_PARSER);
