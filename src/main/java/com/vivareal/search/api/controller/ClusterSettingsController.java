...
public class ClusterSettingsController {
    ...
    @RequestMapping(value = "/properties/local", method = GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = "/properties/remote", method = GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
