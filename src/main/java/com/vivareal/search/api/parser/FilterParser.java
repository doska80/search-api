...
public class FilterParser {
    ...
    private static final Parser<?> IN_OP_PARSER = Terminals.operators("IN").tokenizer();
    ...
    private static final Parser<Filter> EXPRESSION_PARSER = Parsers.or(MULTI_EXPRESSION_PARSER, SINGLE_EXPRESSION_PARSER);
