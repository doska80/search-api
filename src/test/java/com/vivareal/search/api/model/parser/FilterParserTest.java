...
public class FilterParserTest {
    ...
    public FilterParserTest() {
        this.filterParser = new FilterParser(new FieldParser(new NotParser()), new OperatorParser(), new ValueParser());
    }
    ...
    public void testInvalidRelationalViewports() {
        filterParser.get().parse("address.geoLocation EQ [[-23.5534103,-46.6597479],[-23.5534103,-46.6597479]]");
    }
    ...
    public void testInvalidMultipleViewports() {
        filterParser.get().parse("address.geoLocation VIEWPORT [[-46.6597479],[-23.5534103,-46.6597479]]");
    }

    @Test(expected = ParserException.class)
    public void testInvalidMultipleViewportsOnSecond() {
        filterParser.get().parse("address.geoLocation VIEWPORT [[-23.5534103,-46.6597479],[-23.5534103]]");
    }
