...
public class GeoPointValueParserTest {
  ...
  public void testPolygon() {
    Value parse =
        valueParser.getGeoPointValue(Type.POLYGON).parse("[[42.0,-74.0],[-40.0,-72.0],[-30,-23]]");
    assertEquals("[[42.0, -74.0], [-40.0, -72.0], [-30.0, -23.0]]", parse.toString());
  }

  @Test(expected = ParserException.class)
  public void testPolygonWithLessThan3Points() {
    valueParser.getGeoPointValue(Type.POLYGON).parse("[[42.0,-74.0],[-40.0,-72.0]]");
  }

  @Test(expected = ParserException.class)
  public void testPolygonWithInvalidPointLeft() {
    valueParser.getGeoPointValue(Type.POLYGON).parse("[[,-74.0],[-40.0,-72.0],[-30,-23]]");
  }

  @Test(expected = ParserException.class)
  public void testPolygonWithInvalidPointRigth() {
    valueParser.getGeoPointValue(Type.POLYGON).parse("[[42.0,-74.0],[-40.0,-72.0],[-30,]]");
  }

  @Test
  public void testViewport() {
    Value parse = valueParser.getGeoPointValue(Type.VIEWPORT).parse("[[42.0,-74.0],[-40.0,-72.0]]");
    assertEquals("[[42.0, -74.0], [-40.0, -72.0]]", parse.toString());
  }

  @Test
  public void testSingle() {
    Value parse = valueParser.getGeoPointValue(Type.SINGLE).parse("[42.0,-74.0]");
